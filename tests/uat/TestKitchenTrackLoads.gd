...
func test_kitchen_track_scene_loads_with_runtime_nodes() -> void:
	...
	assert_true(instance.get_node_or_null("BuiltTrack/Dressing/KitchenDoorFrameTop") != null, "Kitchen front wall should include a visible doorway")
...
func test_kitchen_authoring_scene_builds_editor_preview() -> void:
	...
	assert_equal(int(summary.get("dressing_props", 0)), 1, "Kitchen builder should report editable dressing props")
