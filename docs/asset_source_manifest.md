...
| Canva audio | 16 | Jacks deploy, jacks hit, bubble pop, invincibility start/end, signature charge/activate, boost burst, drift release, marble fire/hit, item pickup/roulette, kart bump, wall scrape, and heavy landing sound effects |

Total sourced non-import files: 186.
...
- The Canva jacks deploy, jacks hit, bubble pop, invincibility start/end, signature charge/activate, boost burst, drift release, marble fire/hit, item pickup/roulette, kart bump, wall scrape, and heavy landing MP4s were converted to mono 44.1 kHz PCM WAV source files for Godot import.
