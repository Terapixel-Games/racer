...
static func _build_section_markers(root: Node3D, definition: TrackDefinition) -> void:
	...
	root.add_child(holder)
	_add_section_marker(holder, "StartFinishStraight", Vector3(-46, 3.2, -78))
	_add_section_marker(holder, "StoveHairpin", Vector3(-100, 3.2, -24))
	_add_section_marker(holder, "IslandSweeper", Vector3(22, 3.2, -38))
	_add_section_marker(holder, "BackStraight", Vector3(112, 3.2, 18))
	_add_section_marker(holder, "SinkChicane", Vector3(-8, 3.2, 74))
	_add_section_marker(holder, "FridgeCorner", Vector3(84, 3.2, 72))
...
static func _build_dressing(root: Node3D, definition: TrackDefinition) -> void:
	...
	_add_visual_box(holder, "StartFinishTape", Vector3(-48, 3.08, -77.4), Vector3(1.9, 0.06, 13.0), -4.0, Color(0.04, 0.04, 0.04))
	_add_visual_box(holder, "UnderCabinetLedStrip", Vector3(-12, 2.92, -75.8), Vector3(92.0, 0.08, 0.7), 0.0, Color(0.3, 0.92, 1.0))
	_add_visual_box(holder, "StoveHeatZone", Vector3(-98, 3.08, -24), Vector3(15.0, 0.06, 32.0), -18.0, Color(1.0, 0.34, 0.12))
	_add_visual_box(holder, "IslandSweeperBankStripe", Vector3(28, 3.1, -55), Vector3(72.0, 0.06, 1.6), -5.0, Color(0.18, 0.62, 1.0))
	_add_visual_box(holder, "BackStraightSpeedStrip", Vector3(112, 3.1, 10), Vector3(1.7, 0.06, 78.0), 0.0, Color(1.0, 0.9, 0.2))
	_add_visual_box(holder, "SinkChicaneWetStrip", Vector3(-8, 3.1, 74), Vector3(58.0, 0.06, 1.7), 4.0, Color(0.2, 0.62, 0.95))
	_add_visual_box(holder, "FridgeCornerRecoveryStripe", Vector3(86, 3.1, 72), Vector3(20.0, 0.06, 14.0), -20.0, Color(0.7, 0.86, 1.0))
	...
	_add_scene_instance(holder, "res://assets/source/kenney/food_kit/cooking-spoon.glb", Vector3(-8, 3.15, 72), 92.0, Vector3(8.0, 8.0, 8.0), "SpoonHazard")
	_add_scene_instance(holder, "res://assets/source/kenney/food_kit/cutting-board.glb", Vector3(18, 3.05, 0), 116.0, Vector3(7.0, 7.0, 7.0), "CuttingBoard")
	_add_scene_instance(holder, "res://assets/source/kenney/food_kit/cup.glb", Vector3(-36, 3.05, -78), 90.0, Vector3(6.4, 6.4, 6.4), "FrontCupHazard")
	_add_scene_instance(holder, "res://assets/source/kenney/food_kit/apple.glb", Vector3(24, 3.12, -78), 18.0, Vector3(6.2, 6.2, 6.2), "RollingAppleHazard")
	_add_scene_instance(holder, "res://assets/source/kenney/food_kit/bowl.glb", Vector3(70, 3.05, -66), 130.0, Vector3(6.8, 6.8, 6.8), "ShortcutBowlMarker")
	_add_scene_instance(holder, "res://assets/source/kenney/food_kit/cooking-knife.glb", Vector3(-98, 3.14, -40), -34.0, Vector3(6.0, 6.0, 6.0), "OvenKnifeGate")
	_add_scene_instance(holder, "res://assets/source/meshy/2026-04-27-character-track-batch/sir_clink/landmark_set.glb", Vector3(-40, 2.4, 74), 35.0, Vector3(2.2, 2.2, 2.2), "SirClinkLandmark")
