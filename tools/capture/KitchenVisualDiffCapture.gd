...
func _camera_views(route: Array[Vector3]) -> Array[Dictionary]:
	...
	var views: Array[Dictionary] = [
		...
		{
			"id": "countertop_prop_support_profile",
			"position": Vector3(-176.0, 32.0, 122.0),
			"target": Vector3(-126.0, 25.5, 178.0),
			"fov": 38.0,
			"note": "Countertop props must sit on the cabinet/counter support datum without floating.",
		},
		{
			"id": "pantry_shelf_support_profile",
			"position": Vector3(86.0, 26.0, 100.0),
			"target": Vector3(112.0, 18.0, 60.0),
			"fov": 42.0,
			"note": "Pantry goods must sit on shelf datums and stay proportionate to shelf apertures.",
		},
		{
			"id": "under_cabinet_light_mount_profile",
			"position": Vector3(-18.0, 55.0, 128.0),
			"target": Vector3(-8.0, 47.0, 175.0),
			"fov": 36.0,
			"note": "Under-cabinet light strips must mount to cabinet undersides, not float in front of the run.",
		},
		{
			"id": "hood_task_light_mount_profile",
			"position": Vector3(-210.0, 52.0, -82.0),
			"target": Vector3(-265.0, 48.0, -28.0),
			"fov": 38.0,
			"note": "Cooktop task strip must mount to the hood underside/front edge.",
		},
		{
