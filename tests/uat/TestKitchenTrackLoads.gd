...
func test_kitchen_track_scene_loads_with_runtime_nodes() -> void:
	...
	assert_true(instance.get_node_or_null("BuiltTrack/Dressing/StageProps/BackCabinetBaseLeft") != null, "Kitchen back cabinets should be split around the sink")
	assert_true(instance.get_node_or_null("BuiltTrack/Dressing/StageProps/BackCabinetBaseRight") != null, "Kitchen back cabinets should be split around the sink")
	assert_true(instance.get_node_or_null("BuiltTrack/Dressing/StageProps/LeftCabinetBaseFront") != null, "Kitchen left cabinets should be split around the stove")
	assert_true(instance.get_node_or_null("BuiltTrack/Dressing/StageProps/LeftCabinetBaseBack") != null, "Kitchen left cabinets should be split around the stove")
