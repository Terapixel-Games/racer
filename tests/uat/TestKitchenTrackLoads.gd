...
func test_kitchen_track_scene_loads_with_runtime_nodes() -> void:
	...
	assert_true(_node_scale(instance, "BuiltTrack/Dressing/EditableRoom/Track").is_equal_approx(Vector3.ONE), "Kitchen dressing should use normalized measured scale around the fixed 16-wide toy track")
	...
	assert_true(instance.get_node_or_null("BuiltTrack/Dressing/EditableRoom/Track/RoomShell/Ceiling") != null, "Kitchen room shell should include an authored measured ceiling")
