...
func test_kitchen_authoring_scene_builds_editor_preview() -> void:
	...
	assert_true(instance.get_node_or_null("EditorTrackPreview/PreviewMarkers/AudioZones/StoveSizzleZone") != null, "Authoring preview should include stove audio zone radius markers")
	assert_true(instance.get_node_or_null("EditorTrackPreview/PreviewDressingLayout/Dressing/EditableRoom") != null, "Authoring preview should include the editable room dressing layout")
	...
	assert_true(instance.get_node_or_null("EditorTrackPreview/PreviewDressingLayout/DressingLabels/EditableRoom_Label") != null, "Authoring preview should label the editable room dressing")
	instance.queue_free()
