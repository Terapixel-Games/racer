...
| Canva audio | 15 | Jacks deploy, jacks hit, bubble pop, invincibility start/end, signature charge/activate, boost burst, drift release, marble fire/hit, item pickup/roulette, kart bump, and wall scrape sound effects |

Total sourced non-import files: 185.
...
- The Canva jacks deploy, jacks hit, bubble pop, invincibility start/end, signature charge/activate, boost burst, drift release, marble fire/hit, item pickup/roulette, kart bump, and wall scrape MP4s were converted to mono 44.1 kHz PCM WAV source files for Godot import.
