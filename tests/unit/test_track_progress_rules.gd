...
func test_projection_progress_increases_along_route() -> void:
	...
	var near_start := TrackProgressRules.project_position(definition.route_points, Vector3(-54, 3.0, -74), true)
	var later := TrackProgressRules.project_position(definition.route_points, Vector3(94, 3.0, -18), true)
