...
func test_projection_progress_increases_along_route() -> void:
	...
	var near_start := TrackProgressRules.project_position(definition.route_points, Vector3(0, 0.55, -54), true)
	var later := TrackProgressRules.project_position(definition.route_points, Vector3(-64, 0.55, -8), true)
