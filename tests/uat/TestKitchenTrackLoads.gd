...
func test_kitchen_track_scene_loads_with_runtime_nodes() -> void:
	...
	assert_true(instance.get_node_or_null("BuiltTrack/Dressing/EditableRoom/kitchenSink") != null, "Editable room scene should preserve hand-placed kitchen props")
	...
	assert_true(instance.get_node_or_null("BuiltTrack/Dressing/StageProps/KitchenFrontWallLeft") != null, "Kitchen track should include an authored front wall")
	assert_true(instance.get_node_or_null("BuiltTrack/Dressing/StageProps/KitchenFrontWallRight") != null, "Kitchen track should include an authored front wall")
	assert_true(instance.get_node_or_null("BuiltTrack/Dressing/StageProps/KitchenDoorFrameTop") != null, "Kitchen front wall should include a visible doorway")
	...
	assert_true(instance.get_node_or_null("BuiltTrack/Dressing/StageProps/BackCabinetBase") == null, "Kitchen sink should not be blocked by one continuous back cabinet slab")
	assert_true(instance.get_node_or_null("BuiltTrack/Dressing/StageProps/LeftCabinetBase") == null, "Kitchen stove should not be blocked by one continuous left cabinet slab")
	assert_true(instance.get_node_or_null("BuiltTrack/Dressing/StageProps/BackCabinetBaseLeft") == null, "Kitchen back cabinet bases should not create below-track artifacts")
	assert_true(instance.get_node_or_null("BuiltTrack/Dressing/StageProps/BackCabinetBaseRight") == null, "Kitchen back cabinet bases should not create below-track artifacts")
	assert_true(instance.get_node_or_null("BuiltTrack/Dressing/StageProps/LeftCabinetBaseFront") == null, "Kitchen left cabinet bases should not create below-track artifacts")
	assert_true(instance.get_node_or_null("BuiltTrack/Dressing/StageProps/LeftCabinetBaseBack") == null, "Kitchen left cabinet bases should not create below-track artifacts")
	assert_true(instance.get_node_or_null("BuiltTrack/Dressing/StageProps/RightCabinetBase") == null, "Kitchen right cabinet base should not create below-track artifacts")
