...
local kitchen = {
	...
	stage_props = {
		...
		},
		{
			...
			collision_mode = "visual",
			gameplay_tag = "doorway",
			id = "KitchenDoorFrameLeft",
			kind = "box",
			position = {
				-28.0,
				-13.0,
