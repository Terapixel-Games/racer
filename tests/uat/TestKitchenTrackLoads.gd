...
func test_kitchen_track_scene_loads_with_runtime_nodes() -> void:
	...
	var track_body := instance.get_node_or_null("BuiltTrack/TrackBody") as MeshInstance3D
	assert_true(track_body != null, "Kitchen track should include a generated track body support node")
	assert_true(track_body != null and not track_body.visible, "Kitchen grid mode should hide the broad generated track body under RoadGridMap visuals")
